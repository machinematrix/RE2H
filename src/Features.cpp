...
Game::Game()
	...
	mItemCapacityFunction(patternScan("41 8D 40 F1  83 F8 12  77 39  48 98", processName)),
	...
	//damagePlayer(getFunctionPointer<decltype(damagePlayer)>("E8 ????????  48 8B 43 50  48 83 78 18 00  75 ??  85 F6  74 ??  48 8B D7", processName)),
	mHealthBase(patternScan("48 8B 3D ????????  0F5B ??  0F5A ??  48 85 FF  75 ??  45 33 C0  8D 57 38  E8 ????????  E9 ????????  48 8B D7", processName))
{
